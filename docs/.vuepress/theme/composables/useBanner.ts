...
//   let img = axios.get('https://cn.bing.com/HPImageArchive.aspx?format=js&idx=0&n=10&mkt=zh-CN').then((res) => {
//     console.log('res: ', res)
//   })
//   imageArray.push('https://bing.img.run/rand_uhd.php')
// }
...
export const useBanner = () => {
  ...
  let fx: any
  const { bgImage, bgImageSec = 4000, isBgImagetrigger = true, needDefaultImages = true, heroText, tagline, bgImageStyle = { height: '550px', color: '#fff' }, showArrow = true, bubbles = true } = frontmatter.value
  /**banner组件参数 */
